...
router.post("/upload_event", auth.patientRequired, event.upload_event);
/* 病人权限以上 结束 */
...
router.get("/get_history_record", auth.patientRequired, chat.get_history_record)
router.get("/get_poll_record", auth.patientRequired, chat.get_poll_record)
